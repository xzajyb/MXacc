...
### 1. 查看文档
- **所有用户**：在仪表板中点击"文档中心"查看VitePress原生界面
- **内嵌模式**：在应用内直接浏览完整文档
- **新窗口**：点击"新窗口打开"获得完整体验

### 2. 访问管理界面
管理员登录后，在仪表板中点击"管理控制台" → "文档管理"标签页
...
### 界面层整合
- **文档查看**: 导航栏"文档中心"直接内嵌VitePress
- **管理功能**: 集成在管理控制台的"文档管理"标签页
- **统一体验**: 无需跳转，在应用内完成所有操作
- **双重模式**: 支持内嵌查看和新窗口打开
