import{_ as h,c as b,o as v,ae as x}from"./chunks/framework.B-Fvu48Z.js";if(typeof window<"u"){let l=function(e,t){const i=document.getElementById("dynamic-wiki-content");let n=t.length>0?t[0]:null;const d=`
    ...
    `},f=function(e,t){if(!e)return"未分类";const i=t.find(n=>n.id===e);return i?i.name:"未分类"},a=[],r=[];document.addEventListener("DOMContentLoaded",function(){s()});async function s(){try{const[e,t]=await Promise.all([fetch("/api/social/content?action=wiki&type=categories"),fetch("/api/social/content?action=wiki&type=list")]),i=await e.json(),n=await t.json();i.success&&n.success?(r=i.data||[],a=n.data||[],l(r,a)):document.getElementById("dynamic-wiki-content").innerHTML='<div style="text-align: center; padding: 2rem; color: red;"><p>加载文档失败，请稍后重试</p></div>'}catch(e){console.error("加载Wiki内容失败:",e),document.getElementById("dynamic-wiki-content").innerHTML='<div style="text-align: center; padding: 2rem; color: red;"><p>网络错误，请检查连接后重试</p></div>'}}window.selectDocument=g}const D=JSON.parse('{"title":"MXacc 文档中心","description":"","frontmatter":{"layout":"page"},"headers":[],"relativePath":"index.md","filePath":"index.md","lastUpdated":1751436438000}'),k={name:"index.md"};function w(a,r,s,l,m,g){return v(),b("div",null,r[0]||(r[0]=[x('<h1 id="mxacc-文档中心" tabindex="-1">MXacc 文档中心 <a class="header-anchor" href="#mxacc-文档中心" aria-label="Permalink to &quot;MXacc 文档中心&quot;">​</a></h1><p>欢迎使用 MXacc 账号管理系统文档中心。</p><div id="dynamic-wiki-content"><div style="text-align:center;padding:2rem;"><div style="width:40px;height:40px;border:4px solid #f3f3f3;border-top:4px solid #3498db;border-radius:50%;animation:spin 1s linear infinite;margin:0 auto 1rem;"></div><p>正在加载文档内容...</p></div></div>',3)]))}const $=h(k,[["render",w]]);export{D as __pageData,$ as default};
